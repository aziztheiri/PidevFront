...
export class SinistreService {
  ...
  updateSinistre(id: number, sinistre: Sinistre): Observable<Sinistre> {
    return this.http.put<Sinistre>(`${this.apiUrl}/${id}`, sinistre).pipe(
      tap(() => this.notificationService.showSuccess('Sinistre mis à jour avec succès !'))
    );
